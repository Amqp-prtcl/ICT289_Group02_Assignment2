...
static struct graph_wall walls[] = {
        ...
        // Corner table EXTERIOR
    {
        ...
        {TABLE_LENGTH/2-HOLE_RADIUS, 0, TABLE_WIDTH/2},
        {TABLE_LENGTH/2-HOLE_RADIUS, -TABLE_HEIGHT-0.01, TABLE_WIDTH/2},
    },
    {
        {1, 0, 0},
        BEZIER3,
        ...
        {-TABLE_LENGTH/2, 0, TABLE_WIDTH/2},
        {-TABLE_LENGTH/2, 0, TABLE_WIDTH/2-HOLE_RADIUS},
        {-TABLE_LENGTH/2, -TABLE_HEIGHT-0.01, TABLE_WIDTH/2-HOLE_RADIUS},
    },
    {
        {1, 0, 0},
        BEZIER3,
        ...
        // Corner table INTERIOR
    {
        ...
        {PLAYFIELD_LENGTH/2, -TABLE_HEIGHT-0.01, PLAYFIELD_WIDTH/2+HOLE_RADIUS},
    },
    {
        {0.5, 0.5, 0.5},
        BEZIER3,
        ...
        // Corner table LINK
    {
        ...
        B,
        {TABLE_LENGTH/2, TABLE_HEIGHT+0.01, TABLE_WIDTH/2-HOLE_RADIUS},
        {TABLE_LENGTH/2, TABLE_HEIGHT+0.01, TABLE_WIDTH/2},
        {TABLE_LENGTH/2-HOLE_RADIUS, TABLE_HEIGHT+0.01, TABLE_WIDTH/2},
        {PLAYFIELD_LENGTH/2, TABLE_HEIGHT+0.01, PLAYFIELD_WIDTH/2+HOLE_RADIUS},
    },
    {
        ...
        {-TABLE_LENGTH/2, TABLE_HEIGHT+0.01, TABLE_WIDTH/2},
        {-TABLE_LENGTH/2, TABLE_HEIGHT+0.01, TABLE_WIDTH/2-HOLE_RADIUS},
        {-PLAYFIELD_LENGTH/2-HOLE_RADIUS, TABLE_HEIGHT+0.01, PLAYFIELD_WIDTH/2},
    },
    {
        {0.5, 0.5, 0.5},
        B,
        ...
        // Corner table MIDDLE
    {
        ...
        {-HOLE_RADIUS, 0, PLAYFIELD_WIDTH/2+HOLE_RADIUS/2},
        {-HOLE_RADIUS, -TABLE_HEIGHT-0.01, PLAYFIELD_WIDTH/2+HOLE_RADIUS/2},
    },
    {
        {0.5, 0.5, 0.5},
        BEZIER3,
        ...
        // Corner table Ling MIDDLE
    {
        {0.5, 0.5, 0.5},
        B,
        {HOLE_RADIUS, TABLE_HEIGHT+0.01, PLAYFIELD_WIDTH/2+2*HOLE_RADIUS},
        {0, TABLE_HEIGHT+0.01, PLAYFIELD_WIDTH/2+HOLE_RADIUS+(TABLE_WIDTH-PLAYFIELD_WIDTH)/2},
        {-HOLE_RADIUS, TABLE_HEIGHT+0.01, PLAYFIELD_WIDTH/2+2*HOLE_RADIUS},
        {-HOLE_RADIUS, TABLE_HEIGHT+0.01, PLAYFIELD_WIDTH/2+HOLE_RADIUS/2},
    },
    {
