...
#define BROWN_LIGHT_DARK {0.30, 0.15, 0}
#define BROWN_DARK {0.2, 0.1, 0}
#define GRAY {0.5, 0.5, 0.5}
#define DARK_GRAY {0.24, 0.24, 0.16}
...
static struct graph_wall walls[] = {
    ...
    // TOP LEFT 
    {
	    ...
	    POLYGON,
	    {PLAYFIELD_LENGTH/2, 0, PLAYFIELD_WIDTH/2-HOLE_RADIUS},
        {PLAYFIELD_LENGTH/2-HOLE_RADIUS, -TABLE_GROUND_HEIGHT, PLAYFIELD_WIDTH/2-2*HOLE_RADIUS},
        {PLAYFIELD_LENGTH/2-2*HOLE_RADIUS, -TABLE_GROUND_HEIGHT, PLAYFIELD_WIDTH/2-3*HOLE_RADIUS},
        {PLAYFIELD_LENGTH/2-2*HOLE_RADIUS, 0, PLAYFIELD_WIDTH/2-3*HOLE_RADIUS},
    },
    {
        BROWN_LIGHT_DARK,
	    POLYGON,
	    {PLAYFIELD_LENGTH/2, 0, PLAYFIELD_WIDTH/2-HOLE_RADIUS},
        {PLAYFIELD_LENGTH/2-HOLE_RADIUS, -TABLE_GROUND_HEIGHT, PLAYFIELD_WIDTH/2-2*HOLE_RADIUS},
        {PLAYFIELD_LENGTH/2-2*HOLE_RADIUS, -TABLE_GROUND_HEIGHT, PLAYFIELD_WIDTH/2-HOLE_RADIUS},
        {PLAYFIELD_LENGTH/2-HOLE_RADIUS, 0, PLAYFIELD_WIDTH/2},
    },
    {
        BROWN_DARK,
	    ...
	    {PLAYFIELD_LENGTH/2-HOLE_RADIUS, 0, PLAYFIELD_WIDTH/2},
        {PLAYFIELD_LENGTH/2-2*HOLE_RADIUS, -TABLE_GROUND_HEIGHT, PLAYFIELD_WIDTH/2-HOLE_RADIUS},
        {PLAYFIELD_LENGTH/2-3*HOLE_RADIUS, -TABLE_GROUND_HEIGHT, PLAYFIELD_WIDTH/2-2*HOLE_RADIUS},
        {PLAYFIELD_LENGTH/2-3*HOLE_RADIUS, 0, PLAYFIELD_WIDTH/2-2*HOLE_RADIUS},
    },
    {
        BROWN_LIGHT_DARK,
	    POLYGON,
